package com.kerberos.dbflute.cbean.cq.ciq;
...
import com.kerberos.dbflute.cbean.cq.bs.*;
import com.kerberos.dbflute.cbean.cq.*;

/**
 * The condition-query for in-line of line_property_m.
 * @author DBFlute(AutoGenerator)
 */
public class LinePropertyMCIQ extends AbstractBsLinePropertyMCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsLinePropertyMCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public LinePropertyMCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsLinePropertyMCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueLinePropId() { return _myCQ.xdfgetLinePropId(); }
    ...
    public String keepSpecifyMyselfDerived(LinePropertyMCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(LinePropertyMCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(LinePropertyMCQ sq)
    ...
    protected String xinCB() { return LinePropertyMCB.class.getName(); }
    protected String xinCQ() { return LinePropertyMCQ.class.getName(); }
}
